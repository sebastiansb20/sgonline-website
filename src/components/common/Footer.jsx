  ...
  return (
    <div className='w-full flex md:flex-row #000300 justify-between'>
        <div className='flex flex-col m-20'>
            <h2 className='font-bold text-white  text-2xl font-montserrat'>Navegación</h2>
        ...
        <div className='flex flex-col m-20'>
            <h2 className='font-bold text-white  text-2xl font-montserrat'>Nosotros</h2>
            ...
            <div className='flex flex-row ml-4 gap-3'>
                <a href='https://instagram.com/' target='_blank'><img src='/assets/images/logo-instagram.webp' className='size-12 grayscale hover:grayscale-0'/></a>
                <a href='https://web-whatsapp.com/' target='_blank'><img src='/assets/images/logo-whatsapp.webp' className='size-12 grayscale hover:grayscale-0'/></a>
        </div>
        </div>
